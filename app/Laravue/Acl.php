...
final class Acl
{
    ...
    const PERMISSION_VIEW_MENU_CAMPAIGN = 'view menu campaign';
    const PERMISSION_VIEW_MENU_RESULTS = 'view menu results';
    ...
    const PERMISSION_CAMPAIGN_MANAGE = 'manage campaign';
